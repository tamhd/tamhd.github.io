...
\begin{innerlist}
    ...
    \begin{innerlist}
        ...
        \item Design solution and implement systems to correct student's writing automatically.
    \end{innerlist}
\end{innerlist}
...
\item[] \textit{Intern}%
    \begin{innerlist}
    \item Implement triangulation tools for Moses (Statistical Machine Translation - SMT)   
    \item Design SMT homeworks on CodEx
...
\begin{innerlist}
\item[] \textit{Organizer of meetings and club events} %\textit{Assistant Lecturer}%
\end{innerlist}
